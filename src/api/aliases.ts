...
export const API_ID_ALIASES: Record<string, string> = {
  ...
  astradreir: 'dreir',
  taubroadside: 'tsonji',
  tauFarsight: 'farsight',
  admecdestroyer: 'sygex',
  ...
  emperkakophonist: 'adamatar',
  emperflawlessblade: 'hascule',
  emperexultant: 'laviscus',
  spacewolfpriest: 'baldr',
  thousdaemonprince: 'zkar',
  votanironmaster: 'vynn',
  votanmemnyr: 'ammuk',
  deathcrawler: 'plaguecrawler',
