...
const DMG_CALGAR_OTHER = table('RitesOfBattle', 'extraDmg');
...
export const BUFF_PRESETS: BuffPreset[] = [
  ...
  {
    name: 'Calgar — Non-Imperial damage',
    description:
      'Passive Rites of Battle. Adjacent non-Imperial allies gain +extraDmg damage (lower than the Imperial-only buff).',
    charId: 'calgar',
    damageTable: DMG_CALGAR_OTHER,
    level: DEFAULT_BUFF_LEVEL,
    rarity: DEFAULT_BUFF_RARITY,
  },
  {
